...
export default Register;
            ...
            {/* Face Recognition 
            <div className={`border-2 rounded-lg p-6 transition-all ${
              faceData.length >= 3 ? 'border-green-500 bg-green-50' : 'border-gray-200 bg-white'
            }`}>
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center">
                  <div className={`p-2 rounded-full ${faceData.length >= 3 ? 'bg-green-500' : 'bg-primary-600'}`}>
                    <Camera className="h-5 w-5 text-white" />
                  </div>
                  <div className="ml-3">
                    <h4 className="font-semibold text-gray-900">Face Recognition</h4>
                    <p className="text-xs text-gray-500">Capture 3 clear face photos using the webcam</p>
                  </div>
                </div>
                <div className="flex items-center">
                  {faceData.length >= 3 ? (
                    ...
                    <span className="text-sm font-medium text-gray-600">{faceData.length}/3 samples</span>
                  )}
                </div>
              </div>
              ...
              >
                {faceData.length >= 3 ? '✅ All Samples Captured' : `📷 Capture Sample ${faceData.length + 1}/3`}
              </button>
            </div> */}